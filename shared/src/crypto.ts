...
export const toBase64 = (bytes: Uint8Array): string => encodeBase64(bytes);
export const fromBase64 = (s: string): Uint8Array => decodeBase64(s);
export const randomBytes = (n: number): Uint8Array => nacl.randomBytes(n);
export const constantTimeEqual = (a: Uint8Array, b: Uint8Array): boolean => nacl.verify(a, b);
...
export const seal = (
  ...
  if (!box) throw new Error("encryption_failed");
...
export const open = (
  ...
  if (!msg) throw new Error("decryption_failed");
...
export const hashPin = (pin: string, salt: Uint8Array, iterations = 10000): Uint8Array => {
...
export const hmacChallenge = (pairingSecret: Uint8Array, nonce: Uint8Array): Uint8Array =>
  hmacSha512(pairingSecret, nonce).subarray(0, 32);
...
export const deterministicSalt = (
